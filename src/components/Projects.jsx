...
export default function Projects() {
  ...
  return (
    <section id="projects" className="h-screen flex flex-col dark:text-text text-textlight items-center justify-center px-6 z-10">
      ...
      <div className="flex w-full max-w-6xl h-96">
          ...
          {projects.map((project, index) => (
            <motion.button
              ...
              className={`p-2 text-left text-lg font-semibold transition-all ${
                activeProject.title === project.title ? "dark:text-primary text-primarylight scale-105" : "dark:hover:text-primary hover:text-primarylight"
              }`}
            >
        ...
        <div className="w-2/3 flex flex-col items-center">
          <motion.video
            key={activeProject.video} // Ensures video resets on hover change
