    ...
    >
      <div className="max-w-2xl dark:text-white text-textlight z-10">
        ...
        <p className="text-lg md:text-xl opacity-80 leading-relaxed">
          Hi! I'm <span className="dark:text-primary text-primarylight font-semibold">Sapir Talker</span>, As an Information Systems Engineering graduate, I love building things—whether it’s scalable web applications, automating workflows, or uncovering insights from data.<br></br> With a mix of DevOps, Full-Stack Development, and Data Analysis, I love turning ideas into reality.<br></br>
